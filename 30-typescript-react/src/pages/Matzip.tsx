...
import CardContainer from "../components/practice/CardComponent";
...
export default function Matzip() {
  ...
  const [showDobong, setShowDobong] = useState(false);
  ...
  return (
    <>
      ...
      <Inner>
        <GridDiv>
          <CardContainer showContent={showGangdong} matzipInfo={gangdongArr} />
          <CardContainer showContent={showMapo} matzipInfo={mapoArr} />
          <CardContainer showContent={showDobong} matzipInfo={dobongArr} />
        </GridDiv>
      </Inner>
    </>
  );
