...
// 쿠키 가져오기
// req.cookies에 담겨져서 온다
app.get("/getCookie", (req, res) => {
  //   console.log(req.cookies); // ver1. 암호화되지 않은 쿠키일 때
  //   res.send(req.cookies);
  console.log(req.signedCookies); // ver2. 암호화되지 않은 쿠키일 때
