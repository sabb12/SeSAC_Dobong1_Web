...
const sessionConfig = {
  /*
        - secret: 안전한 쿠키 전송을 위한 서명 값 (필수)
        - resave: 세션 수정사항 생기지 않더라도 메 요청마다 세션을 다시 저장할지 (false 권장)
...
app.get("/name", (req, res) => {
  ...
  // fXtH0HS3PJqXmJozQOyK3dKTZu371vj1
